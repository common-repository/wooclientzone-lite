...
delete_option('wooclientzone_items_loaded');
...
// this option would be set if using the free plugin and settings were saved at least once
delete_option('wooclientzone_upgrade_to_premium_version');
delete_option('wooclientzone_rating_done');
