 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WooClientZone Lite
 * Plugin URI:        https://wordpress.org/plugins/wooclientzone-lite/
 * Description:       This plugin integrates with WooCommerce to create areas where clients and merchants can interact by exchanging rich-text messages.
 * Version:           1.1
...
define('WOOCLIENTZONE_DOCS_LINK', "http://blendscapes.com/wooclientzone_lite_documentation/");
define('WOOCLIENTZONE_UPGRADE_LINK', "http://blendscapes.com/upgrade-wooclientzone/");
define('WOOCLIENTZONE_RATING_LINK', "https://wordpress.org/support/view/plugin-reviews/wooclientzone-lite?filter=5#postform");
